...
class GroupManagerService_AddGroupTask_args {
 public:
  ...
  GroupManagerService_AddGroupTask_args(const GroupManagerService_AddGroupTask_args&);
  GroupManagerService_AddGroupTask_args& operator=(const GroupManagerService_AddGroupTask_args&);
...
class GroupManagerService_AddGroupTask_result {
 public:
  ...
  GroupManagerService_AddGroupTask_result(const GroupManagerService_AddGroupTask_result&);
  GroupManagerService_AddGroupTask_result& operator=(const GroupManagerService_AddGroupTask_result&);
...
class GroupManagerService_GetTaskStatus_args {
 public:
  ...
  GroupManagerService_GetTaskStatus_args(const GroupManagerService_GetTaskStatus_args&);
  GroupManagerService_GetTaskStatus_args& operator=(const GroupManagerService_GetTaskStatus_args&);
...
class GroupManagerService_GetTaskStatus_result {
 public:
  ...
  GroupManagerService_GetTaskStatus_result(const GroupManagerService_GetTaskStatus_result&);
  GroupManagerService_GetTaskStatus_result& operator=(const GroupManagerService_GetTaskStatus_result&);
...
class GroupManagerService_ControlTask_args {
 public:
  ...
  GroupManagerService_ControlTask_args(const GroupManagerService_ControlTask_args&);
  GroupManagerService_ControlTask_args& operator=(const GroupManagerService_ControlTask_args&);
...
class GroupManagerService_ControlTask_result {
 public:
  ...
  GroupManagerService_ControlTask_result(const GroupManagerService_ControlTask_result&);
  GroupManagerService_ControlTask_result& operator=(const GroupManagerService_ControlTask_result&);
...
class GroupManagerService_SetTaskOption_args {
 public:
  ...
  GroupManagerService_SetTaskOption_args(const GroupManagerService_SetTaskOption_args&);
  GroupManagerService_SetTaskOption_args& operator=(const GroupManagerService_SetTaskOption_args&);
...
class GroupManagerService_SetTaskOption_result {
 public:
  ...
  GroupManagerService_SetTaskOption_result(const GroupManagerService_SetTaskOption_result&);
  GroupManagerService_SetTaskOption_result& operator=(const GroupManagerService_SetTaskOption_result&);
...
class GroupManagerService_GetTaskOption_args {
 public:
  ...
  GroupManagerService_GetTaskOption_args(const GroupManagerService_GetTaskOption_args&);
  GroupManagerService_GetTaskOption_args& operator=(const GroupManagerService_GetTaskOption_args&);
...
class GroupManagerService_GetTaskOption_result {
 public:
  ...
  GroupManagerService_GetTaskOption_result(const GroupManagerService_GetTaskOption_result&);
  GroupManagerService_GetTaskOption_result& operator=(const GroupManagerService_GetTaskOption_result&);
...
class GroupManagerServiceConcurrentClient : virtual public GroupManagerServiceIf {
 public:
  GroupManagerServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  GroupManagerServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
 ...
 public:
  ...
  void AddGroupTask(GeneralResponse& _return, const DownloadParam& down_params, const UserCred& cred);
  int32_t send_AddGroupTask(const DownloadParam& down_params, const UserCred& cred);
  void recv_AddGroupTask(GeneralResponse& _return, const int32_t seqid);
  void GetTaskStatus(std::vector<TaskStatus> & _return, const std::string& infohash, const bool is_full);
  int32_t send_GetTaskStatus(const std::string& infohash, const bool is_full);
  void recv_GetTaskStatus(std::vector<TaskStatus> & _return, const int32_t seqid);
  void ControlTask(GeneralResponse& _return, const std::string& infohash, const bool is_all, const ControlTaskType::type type, const UserCred& cred);
  int32_t send_ControlTask(const std::string& infohash, const bool is_all, const ControlTaskType::type type, const UserCred& cred);
  void recv_ControlTask(GeneralResponse& _return, const int32_t seqid);
  void SetTaskOption(GeneralResponse& _return, const TaskOptions& options);
  int32_t send_SetTaskOption(const TaskOptions& options);
  void recv_SetTaskOption(GeneralResponse& _return, const int32_t seqid);
  void GetTaskOption(std::vector<TaskOptions> & _return, const std::string& infohash);
  int32_t send_GetTaskOption(const std::string& infohash);
  void recv_GetTaskOption(std::vector<TaskOptions> & _return, const int32_t seqid);
 protected:
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
